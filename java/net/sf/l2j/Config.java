...
public final class Config
{
	...
	public static int CHAT_MIN_LEVEL;
	public static int CHAT_MIN_PVP;
	public static int OLY_PERIOD;
	public static int OLY_PERIOD_MULTIPLIER;
	public static boolean SHIFT_CLICK;
	
	/** Login announce */
	public static String HERO_ANNOUNCE;
	public static String CASTLE_LORD_ANNOUNCE;
	public static String TOP_PLAYER_ANNOUNCE;
	public static String BOSS_DEATH_ANNOUNCE;
	...
	/** Sieges */
	public static int SIEGE_GLUDIO;
	public static int SIEGE_DION;
	public static int SIEGE_GIRAN;
	public static int SIEGE_OREN;
	public static int SIEGE_ADEN;
	public static int SIEGE_INNADRIL;
	public static int SIEGE_GODDARD;
	public static int SIEGE_RUNE;
	public static int SIEGE_SCHUTTGART;
	public static int SIEGE_INTERVAL;
	
	/** Pvp System */
	public static int[][] PVP_REWARD;
	public static int[][] PK_REWARD;
	public static Map<Integer, Integer> PVP_COLOR_LIST = new HashMap<>();
	public static Map<Integer, Integer> PK_COLOR_LIST = new HashMap<>();
	...
	private static final void loadCustoms()
	{
		...
		CHAT_MIN_LEVEL = customs.getProperty("ChatMinLevel", 40);
		CHAT_MIN_PVP = customs.getProperty("ChatMinPvp", 10);
		
		OLY_PERIOD = customs.getProperty("OlyPeriod", 1);
		OLY_PERIOD_MULTIPLIER = customs.getProperty("OlyPeriodMultiplier", 1);
		
		SHIFT_CLICK = customs.getProperty("EnableShiftClick", false);
		
		HERO_ANNOUNCE = customs.getProperty("HeroAnnounce", "");
		CASTLE_LORD_ANNOUNCE = customs.getProperty("CastleLordAnnounce", "");
		TOP_PLAYER_ANNOUNCE = customs.getProperty("TopPlayerAnnounce", "");
		BOSS_DEATH_ANNOUNCE = customs.getProperty("BossDeathAnnounce", "");
		PVP_MESSAGE = customs.getProperty("PvpMessage", "");
		PK_MESSAGE = customs.getProperty("PkMessage", "");
		
		MAX_PATK = customs.getProperty("MaxPAtk", 10000);
		MAX_MATK = customs.getProperty("MaxMAtk", 10000);
		
		SIEGE_GLUDIO = customs.getProperty("SiegeGludio", 7);
		SIEGE_DION = customs.getProperty("SiegeDion", 7);
		SIEGE_GIRAN = customs.getProperty("SiegeGiran", 1);
		SIEGE_OREN = customs.getProperty("SiegeOren", 1);
		SIEGE_ADEN = customs.getProperty("SiegeAden", 1);
		SIEGE_INNADRIL = customs.getProperty("SiegeInnadril", 1);
		SIEGE_GODDARD = customs.getProperty("SiegeGoddard", 1);
		SIEGE_RUNE = customs.getProperty("SiegeRune", 7);
		SIEGE_SCHUTTGART = customs.getProperty("SiegeSchuttgart", 7);
		SIEGE_INTERVAL = customs.getProperty("SiegeInterval", 14);
		
		PVP_REWARD = parseItemsList(customs.getProperty("PvpReward", "57,100"));
		PK_REWARD = parseItemsList(customs.getProperty("PkReward", "5575,100"));
		
		final String[] pvpData = customs.getProperty("PvpColorList", (String[]) null, ";");
		if (pvpData != null)
		{
			for (String data : pvpData)
			{
				final String[] value = data.split("-");
				PVP_COLOR_LIST.put(Integer.parseInt(value[0]), Integer.decode("0x" + value[1]));
			}
		}
		
		final String[] pkData = customs.getProperty("PkColorList", (String[]) null, ";");
		if (pkData != null)
		{
			for (String data : pkData)
			{
				final String[] value = data.split("-");
				PK_COLOR_LIST.put(Integer.parseInt(value[0]), Integer.decode("0x" + value[1]));
			}
		}
	}
