...
public class CreatureStat
{
	...
	public int getMAtk(Creature target, L2Skill skill)
	{
		...
		final int mAtk = (int) calcStat(Stats.MAGIC_ATTACK, attack, target, skill);
		return mAtk > Config.MAX_MATK ? Config.MAX_MATK : mAtk;
	}
	...
	{
		final int pAtk = (int) calcStat(Stats.POWER_ATTACK, _activeChar.getTemplate().getBasePAtk() * ((_activeChar.isChampion()) ? Config.CHAMPION_ATK : 1), target, null);
		return pAtk > Config.MAX_PATK ? Config.MAX_PATK : pAtk;
	}
