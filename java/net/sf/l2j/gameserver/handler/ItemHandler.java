...
import net.sf.l2j.custom.premium.itemhandler.PremiumItemBronze;
import net.sf.l2j.custom.premium.itemhandler.PremiumItemGold;
import net.sf.l2j.custom.premium.itemhandler.PremiumItemSilver;
...
public class ItemHandler
{
	...
	{
		registerHandler(new PremiumItemBronze());
		registerHandler(new PremiumItemGold());
		registerHandler(new PremiumItemSilver());
