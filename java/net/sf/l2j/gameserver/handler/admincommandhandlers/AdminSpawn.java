...
public class AdminSpawn implements IAdminCommandHandler
{
	...
	public boolean useAdminCommand(String command, Player activeChar)
	{
		...
		else if (command.startsWith("admin_respawnall") || command.startsWith("admin_spawn_reload"))
		{
			...
			RaidBossManager.getInstance().reloadBosses();
	...
	private static void spawn(Player activeChar, String monsterId, int respawnTime, boolean permanent)
	{
		...
		try
		{
			...
			if (RaidBossManager.getInstance().getValidTemplate(spawn.getNpcId()) != null)
			{
				if (RaidBossManager.getInstance().isDefined(spawn.getNpcId()))
				{
