...
public class Q604_DaimonTheWhiteEyed_Part2 extends Quest
{
	...
	public Q604_DaimonTheWhiteEyed_Part2()
	{
		...
		switch (RaidBossManager.getInstance().getRaidBossStatusId(DAIMON_THE_WHITE_EYED))
		{
			case ALIVE:
				spawnNpc();
			case DEAD:
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		...
		{
			RaidBoss raid = RaidBossManager.getInstance().getBosses().get(DAIMON_THE_WHITE_EYED);
