...
public class Q625_TheFinestIngredients_Part2 extends Quest
{
	...
	public Q625_TheFinestIngredients_Part2()
	{
		...
		switch (RaidBossManager.getInstance().getRaidBossStatusId(ICICLE_EMPEROR_BUMBALUMP))
		{
			case ALIVE:
				spawnNpc();
			case DEAD:
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		...
		{
			RaidBoss raid = RaidBossManager.getInstance().getBosses().get(ICICLE_EMPEROR_BUMBALUMP);
