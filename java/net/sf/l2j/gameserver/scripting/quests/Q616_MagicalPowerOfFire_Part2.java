...
public class Q616_MagicalPowerOfFire_Part2 extends Quest
{
	...
	public Q616_MagicalPowerOfFire_Part2()
	{
		...
		switch (RaidBossManager.getInstance().getRaidBossStatusId(SOUL_OF_FIRE_NASTRON))
		{
			case ALIVE:
				spawnNpc();
			case DEAD:
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		...
		{
			RaidBoss raid = RaidBossManager.getInstance().getBosses().get(SOUL_OF_FIRE_NASTRON);
