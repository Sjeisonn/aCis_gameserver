...
public class Q610_MagicalPowerOfWater_Part2 extends Quest
{
	...
	public Q610_MagicalPowerOfWater_Part2()
	{
		...
		switch (RaidBossManager.getInstance().getRaidBossStatusId(SOUL_OF_WATER_ASHUTAR))
		{
			case ALIVE:
				spawnNpc();
			case DEAD:
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		...
		{
			RaidBoss raid = RaidBossManager.getInstance().getBosses().get(SOUL_OF_WATER_ASHUTAR);
