...
public class GameServer
{
	...
	public GameServer() throws Exception
	{
		...
		LOGGER.info("VoicedCommandHandler: Loaded {} voiced command handlers.", VoicedCommandHandler.getInstance().size());
		PincodeTable.getInstance();
		IconsTable.getInstance();
		PcCafeManager.getInstance();
		TopPlayerManager.getInstance();
